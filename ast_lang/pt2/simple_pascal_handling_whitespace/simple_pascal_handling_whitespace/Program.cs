...
namespace simple_pascal
{
    ...
    class Program
    {
        ...
        //main lessons:
        // -factor out "indexing" out of the tokenizer, into advance and NextToken methods
        // -you still want to deal with things character-by-character
        // -factor out even more clever parsing stuff!, skipWhitespace is cool, but integer() for accumulating integers in one word is cool, will probably have to do something similar for this::nametype


        //lexeme = sequence of characters that form a token!, so we made a method to comprehend lexemes!
    }
}
