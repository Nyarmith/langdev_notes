...
namespace simple_pascal_parens
{
    //this is pretty much the same as the exercise as before, so it's almost exactly the same(except the dude didn't have a separate rule for INTEGER!) N+1 operator levels axiom violated!!
    class tokens
    {
